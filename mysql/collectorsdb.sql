...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `purchase_price` DECIMAL(11) NOT NULL DEFAULT 0,
  `current_value` DECIMAL(11) NULL,
  `purchase_date` VARCHAR(255) NOT NULL,
  `sold_date` VARCHAR(255) NULL,
  `sold_price` DECIMAL(11) NULL,
